...
//    public final static  String APPID="wx7dee141dcedc0421";//应用id
    ...
    public final static  String GZ_APPID="wx67cadbc58a45b2cd";//公众号APPid
   ...
   // public final static  String NOTIFYURL="https://www.xingyuanji.com/wish/wxpay/notify";//异步结果接口
    public final static  String NOTIFYURL="https://localhost:8082/shopOline/shopLog//notify";//异步结果接口测试
...
//    ===================================支付
    ...
    public static SignModel getSign(String url){
        String nonce_str = create_nonce_str();
        String timestamp = create_timestamp();
        ...
        signModel.setNonceStr(nonce_str);
        signModel.setSignAture(signature);
