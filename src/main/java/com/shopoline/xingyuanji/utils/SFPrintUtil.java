...
public class SFPrintUtil {
    ...
    public static String WayBillPrinterTools(SendHomeModel sendHomeModel, String mailno, ProductInfo productInfo, SFPrintInfoModel sfPrintInfoModel) throws Exception{
       ...
       // String url2 = "http://localhost:4040/sf/waybill/print?type=V2.0_poster_100mm150mm&output=print";
        String url2 = "http://localhost:4040/sf/waybill/print?type=V2.0.FM_poster_100mm150mm&output=print";
        /**
         * 直接输出图片的BASE64编码字符串 可以使用html标签直接转换成图片【二联单】
         */
        String url3 = "http://localhost:4040/sf/waybill/print?type=V2.0.FM_poster_100mm150mm&output=image";
        ...
        //这个必填
        dto.setAppId(Config.Client_CODE);//对应clientCode
        ...
        //快递类型
        //1 ：标准快递   2.顺丰特惠    6：顺丰即日  7.电商速配   15：生鲜速配
